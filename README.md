...
part-1/?utm_source=javascriptweekly&utm_medium=email)

[AppleInsider | SproutCore debuts new HTML5 web development tools](http://www.
...
[gist: 704930 - Minimal example of data handling in Backbone.js-
GitHub](https://gist.github.com/704930#LID7)

[HTML5 and microformats for
pragmatists](http://www.slideshare.net/wojciechzajac/html5-and-microformats-
for-pragmatists-5386409)
...
[Unify Project](http://unify.github.com/unify/)
...
](http://badassjs.com/post/1217357060/hasjs)[BorisMoore/DeferJS - GitHub

](https://github.com/BorisMoore/DeferJS)[Enterprise JavaScript - Provides
proven high performance, enterprise-level and scalable JavaScript tips and
best practices.

](http://enterprise-js.com/)[Entity - JSON Alternative, XML Alternative.

](http://www.entity-format.co.uk/)[Google Closure Compiler with jQuery
applications - Stack Overflow

](http://stackoverflow.com/questions/3218280/google-closure-compiler-with-
jquery-applications)[I was just thinking the same thing..: AJAX Push in iOS,
Safari, and Chrome with Server-Sent Events

](http://blog.samshull.com/2010/10/ajax-push-in-ios-safari-and-chrome-
with.html)[ialexi's hedwig at master - GitHub

](http://github.com/ialexi/hedwig)[javascript - jQuery compiled with Google
Closure Compiler - Stack Overflow

](http://stackoverflow.com/questions/1691861/jquery-compiled-with-google-
closure-compiler)[Javascript Game Development - The Game Loop · nokarma.org

](http://nokarma.org/2010/02/02/javascript-game-development-the-game-
loop/)[jquery - How do I use Google Closure compiler to remove used JavaScript
code? - Stack Overflow

](http://stackoverflow.com/questions/3199062/how-do-i-use-google-closure-
compiler-to-remove-used-javascript-code)[LABjs Script Loader :: Home

](http://labjs.com/)[RequireJS

](http://requirejs.org/)[Tutti - Multiple Browser Interactive Javascript Shell

](http://tobyho.com/Tutti_-
_Multiple_Browser_Interactive_Javascript_Shell)[wtfjs
...
](https://github.com/creationix/adventure)[danwrong/restler - GitHub

](https://github.com/danwrong/restler)[Express - node web framework

](http://expressjs.com/)[jed/fab - GitHub

](https://github.com/jed/fab)[node.js

](http://nodejs.org/)[Node.js Knockout
...
](http://www.p51labs.com/accordion/)[andyMatthews.net - Introduction to jQuery
Mobile

](http://andymatthews.net/read/2011/02/08/Introduction-to-jQuery-Mobile)[Book
Flip - JavaScript only.

](http://www.coastworx.com/bookflip.php)[Booklet - jQuery Plugin

](http://builtbywill.com/code/booklet/)[ICanHaz.js | client-side templating
with Mustache.js and jQuery or Zepto.js

](http://icanhazjs.com/)[Isotope

](http://isotope.metafizzy.co/)[IT News Wire | Tag Archive | Sencha Touch

](http://www.itnewswire.info/tag/sencha-touch)[jQuery Mobile | jQuery Mobile

](http://jquerymobile.com/)[Kitchen Sink

](http://dev.sencha.com/deploy/touch/examples/kitchensink/)[NEW API (Bigger
and Badder) | face.com
